...
export default function AuthBrandedLayout({
    ...
    return (
        <div className="relative flex min-h-svh overflow-hidden bg-[#0A3A6E] text-neutral-900">
            <img
                src="/images/login-hero.png"
                alt=""
                className="absolute inset-0 size-full object-cover object-left"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#061A38]/80 via-[#0A2A5C]/45 to-[#0D9488]/50" />
            <div className="pointer-events-none absolute -top-20 -right-16 size-72 rounded-full bg-[#5EEAD4]/25 blur-3xl" />
            <div className="pointer-events-none absolute -right-10 -bottom-24 size-80 rounded-full bg-[#2DD4BF]/20 blur-3xl" />
            ...
            <div className="relative z-10 flex min-h-svh w-full flex-col">
                <div className="flex flex-1 flex-col gap-10 px-4 py-10 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:px-12 xl:px-16">
                    <div className="hidden max-w-xl text-white lg:block">
                        <p className="text-sm font-semibold tracking-[0.28em] text-[#5EEAD4] uppercase">
                            {name} Platform
                        </p>
                        <h1 className="mt-4 text-4xl font-bold leading-tight tracking-tight xl:text-5xl">
                            ...
                            <br />
                            Driving{' '}
                            <span className="text-[#5EEAD4]">performance.</span>
                        </h1>
                            ...
                            {highlights.map((item) => (
                                ...
                                >
                                    <div className="flex items-center gap-2.5">
                                        <div className="flex size-8 items-center justify-center rounded-lg bg-[#0F766E]/40 text-[#99F6E4]">
                    ...
                    <div className="mx-auto w-full max-w-[420px] lg:mx-0 lg:shrink-0">
                        <div className="mb-6 text-center text-white lg:hidden">
                            <p className="text-xs font-semibold tracking-[0.25em] text-[#5EEAD4] uppercase">
                                {name} Platform
                            </p>
                        ...
                        <div className="rounded-2xl bg-white p-7 shadow-[0_25px_60px_-15px_rgba(10,42,92,0.45)] sm:p-9">
                            <div className="mb-6 flex flex-col items-center text-center">
                                <div className="mb-3 flex size-12 items-center justify-center rounded-full bg-[#0F766E]/10 text-[#0F766E]">
                                    <Users className="size-6" strokeWidth={1.75} />
                                </div>
                                <p className="text-xl font-bold tracking-tight text-[#0F766E]">
                                    {name}
                                </p>
                            </div>
