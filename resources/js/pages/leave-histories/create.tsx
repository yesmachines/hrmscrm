...
import { index, store } from '@/actions/App/Http/Controllers/Leave/LeaveHistoryController';
...
export default function LeaveHistoriesCreate({ leaveRequests, users }: { leaveRequests: any[], users: any[] }) {
    const { data, setData, post, processing, errors } = useForm({
        leave_request_id: '',
        action_type: 'applied',
        remarks: '',
        done_by: '',
        action_on: new Date().toISOString().slice(0, 16),
    });
        ...
        <>
            ...
            <div className="mx-auto flex w-full max-w-full 2xl:max-w-[1200px] flex-1 flex-col gap-6 p-6 md:p-8">
                <div className="flex items-center gap-4">
                    ...
                    <Heading
                        title="Add Leave History Record"
                        description="Manually insert an audit log entry for a leave request"
                    />
                </div>
